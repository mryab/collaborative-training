...
bookcorpus = load_dataset('bookcorpusopen', cache_dir='.data_cache')
...
tokenized_datasets = bookcorpus.map(
    tokenize_function,
    batched=True,
    batch_size=4,
    num_proc=cpu_count(),
...
tokenized_datasets.save_to_disk("albert_tokenized_bookcorpusopen")
